...
const miembros: Miembro[] = [
  // MESA
  { nombre: 'Morena Kopecky',      nivel: 'MESA', area: 'Presidenta' },
  { nombre: 'Luciano Olcina',      nivel: 'MESA', area: 'Vicepresidente' },
  { nombre: 'Luna Aguilera',       nivel: 'MESA', area: 'Secretaria General' },
  { nombre: 'Joaquín Valfré',      nivel: 'MESA', area: 'Secretario Parlamentario' },
  // SEC
  { nombre: 'Cecilia Wagner',      nivel: 'SEC',  area: 'Asuntos Sociales' },
  { nombre: 'Ariana Kopecky',      nivel: 'SEC',  area: 'Derechos Humanos' },
  { nombre: 'Rocío Albornoz',      nivel: 'SEC',  area: 'Finanzas y Hacienda' },
  { nombre: 'Victoria Bailes',     nivel: 'SEC',  area: 'Deportes y Recreación' },
  { nombre: 'Barbara Zambrano',    nivel: 'SEC',  area: 'Arte y Cultura' },
  // SUB
  { nombre: 'Luca Zúñiga',         nivel: 'SUB',  area: 'Derechos Humanos' },
  { nombre: 'Ariadna Cuello',      nivel: 'SUB',  area: 'Problemáticas Edilicias y de Infraestructura' },
  { nombre: 'Antonella Brunetto',  nivel: 'SUB',  area: 'Relaciones Exteriores' },
  { nombre: 'Melina Flores',       nivel: 'SUB',  area: 'Finanzas y Hacienda' },
  // COM
  { nombre: 'Tomi Alzuarena',      nivel: 'COM',  area: 'Derechos Humanos' },
  { nombre: 'Ivan Suarez',         nivel: 'COM',  area: 'Género y Diversidad' },
  { nombre: 'Guille Wagner',       nivel: 'COM',  area: 'Género y Diversidad' },
  { nombre: 'Carolina Villarreal', nivel: 'COM',  area: 'Problemáticas Edilicias y de Infraestructura' },
  { nombre: 'Facundo Aguero',      nivel: 'COM',  area: 'Actas y Archivo' },
  { nombre: 'Alma Jimenez',        nivel: 'COM',  area: 'Salud y Ambiente' },
  { nombre: 'Catalina Cuello',     nivel: 'COM',  area: 'Salud y Ambiente' },
  { nombre: 'Jazmin Bazan',        nivel: 'COM',  area: 'Salud y Ambiente' },
  { nombre: 'Joe Ganmaroto',       nivel: 'COM',  area: 'Salud y Ambiente' },
  { nombre: 'Agustín Vega',        nivel: 'COM',  area: 'Comunicación y Prensa' },
  { nombre: 'Violeta Carraro',     nivel: 'COM',  area: 'Comunicación y Prensa' },
  { nombre: 'Magali Perreya',      nivel: 'COM',  area: 'Comunicación y Prensa' },
  { nombre: 'Ludmila Duarte',      nivel: 'COM',  area: 'Comunicación y Prensa' },
  { nombre: 'Antonella Espindola', nivel: 'COM',  area: 'Relaciones Exteriores' },
  { nombre: 'Celeste Nievas',      nivel: 'COM',  area: 'Relaciones Exteriores' },
  { nombre: 'Thiago Mauje',        nivel: 'COM',  area: 'Deportes y Recreación' },
  { nombre: 'Santino Bartoli',     nivel: 'COM',  area: 'Deportes y Recreación' },
  { nombre: 'Eduardo Rodriguez',   nivel: 'COM',  area: 'Deportes y Recreación' },
  { nombre: 'Sofia Arroyo',        nivel: 'COM',  area: 'Deportes y Recreación' },
  { nombre: 'Valentin Cordero',    nivel: 'COM',  area: 'Arte y Cultura' },
  ...
  { nombre: 'Umma Luera',          nivel: 'COM',  area: 'Arte y Cultura' },
];
